        ...
        ((t = n.DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    orderable: !1,
                    render: function (t, e, s, a) {
                        return '<div class="d-inline-block text-nowrap"><button class="btn btn-sm btn-icon"><i class="ti ti-edit"></i></button><button class="btn btn-sm btn-icon delete-record"><i class="ti ti-trash"></i></button><button class="btn btn-sm btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="ti ti-dots-vertical me-2"></i></button><div class="dropdown-menu dropdown-menu-end m-0"></div></div>';
                    },
                },
            ],
            order: [2, "asc"],
            ...
            buttons: [
                {
                    text: '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Añadir vehículo</span>',
                    className: "add-new btn btn-primary ms-2 ms-sm-0",
                    action: function () {
                        window.location.href = "{{ url('/carform') }}";
                    },
                },
            ],
            responsive: {
